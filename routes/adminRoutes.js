...
router.post('/upload-blueprint', adminMiddleware, upload.single('file'), uploadBlueprint); // Legacy route kept for compatibility
router.post('/blueprints', adminMiddleware, upload.single('file'), uploadBlueprint); // Primary route used by frontend
